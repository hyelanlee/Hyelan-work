...
const InventoryBookHeaderList103 = observer((props) => {
  ...
  const fInitGrid = async () => {
    ...
    props.DataProviderBinder(dataProvider, '10_3');
    props.GridViewBind(gridView, '10_3');
  };
...
export default InventoryBookHeaderList103;
