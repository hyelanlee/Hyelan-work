...
// 재고장 - 원재료, 단조
const InventoryBookHeaderList12 = observer((props) => {
  ...
  const fInitGrid = async () => {
    ...
    props.DataProviderBinder(dataProvider, '1_2');
    props.GridViewBind(gridView, '1_2');
    ...
    gridView.onCellClicked = function (grid, index) {
      if (props.currentIndex.current.원재료 === index.dataRow && index.dataRow >= 0) {
...
export default InventoryBookHeaderList12;
