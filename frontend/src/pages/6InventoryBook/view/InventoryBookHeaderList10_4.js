...
import { GridLayout10_4 } from './InventoryBookGrid';

// 재고장 - 상품, 제품, 반제품 - 구매발주내역
const InventoryBookHeaderList104 = observer((props) => {
  ...
  const fInitGrid = async () => {
    ...
    gridView.setColumnLayout(GridLayout10_4);

    props.DataProviderBinder(dataProvider, '10_4');
    props.GridViewBind(gridView, '10_4');
  };
...
export default InventoryBookHeaderList104;
