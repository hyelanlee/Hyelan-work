...
const InventoryBookHeaderList106 = observer((props) => {
  ...
  const fInitGrid = async () => {
    ...
    props.DataProviderBinder(dataProvider, '10_6');
    props.GridViewBind(gridView, '10_6');
  };
...
export default InventoryBookHeaderList106;
