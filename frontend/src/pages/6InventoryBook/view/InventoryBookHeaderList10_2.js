...
// 재고장 - 상품, 제품, 반제품 - 출고동향 // 원재료, 단조 - 출고동향
const InventoryBookHeaderList102 = observer((props) => {
  ...
  const fInitGrid = async () => {
    ...
    props.DataProviderBinder(dataProvider, '10_2');
    props.GridViewBind(gridView, '10_2');
  };
...
export default InventoryBookHeaderList102;
